...
public class UserAccount extends BaseEntity{
    ...
    @Column(unique = true, nullable = false, columnDefinition = "varchar(50) COMMENT '로그인 아이디'")
    private String userId;
    @Column(nullable = false, columnDefinition = "varchar(255) COMMENT '로그인 비밀번호'")
    private String password;
    @Column(unique = true, nullable = false, columnDefinition = "varchar(100) COMMENT '다른 사용자에게 노출될 이름'")
